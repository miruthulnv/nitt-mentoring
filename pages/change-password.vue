    ...
    <div
      ...
      <form class="flex flex-col items-center gap-4 pt-8" @submit="handleSubmit">
        <div class="flex flex-col items-center gap-2">
          ...
          <input v-model="email" name="email" id="email_field" type="email" placeholder="johndoe@example.com"
            class="p-2 w-full lg:w-96 rounded-md shadow-md" readonly />
        </div>
        <div class="flex flex-col items-center gap-2">
          <label htmlFor="password_field" class="w-full text-start">
            New Password
          </label>
          <input v-model="password" name="password" id="password_field" type="password" placeholder="New Password"
        ...
        <div class="flex flex-col items-center gap-2">
          ...
          <input v-model="confirmPassword" name="confirm_password" id="confirm_password_field" type="password"
            placeholder="Confirm New Password" class="p-2 w-full lg:w-96 rounded-md shadow-md" />
        </div>
        <MiscMessage
